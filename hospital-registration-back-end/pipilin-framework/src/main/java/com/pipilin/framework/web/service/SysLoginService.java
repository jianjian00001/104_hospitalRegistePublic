...
import com.pipilin.common.exception.user.UserPasswordNotMatchException;
...
import com.pipilin.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService
{
     ...
     * @return 结果
     */
    public String miniLogin1(String username, String password)
    {
        // 用户验证
        Authentication authentication = null;
        try
     ...
     * @return 结果
     */
    public String miniLogin(String username, String password)
    {
        // 用户验证
        Authentication authentication = null;
        try
