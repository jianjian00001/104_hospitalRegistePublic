...
import com.pipilin.common.core.domain.entity.SysDept;
...
import com.pipilin.system.service.ISysDeptService;
import com.pipilin.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    {
        return AjaxResult.success(sysUserMapper.selectCount());
    }
    ...
    public AjaxResult changeStatus(@RequestBody SysUser user)
    {
        ...
        if("0".equals(user.getStatus())){
            ...
            sysUserMapper.updateUser1(sysUser);
        }
